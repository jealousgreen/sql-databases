...
--------------------------------------------
-- Задача 2
-- Объединить автомобили, мотоциклы и велосипеды по заданным условиям
/* 
Автомобили:
...
а также NULL для мощности и объема двигателя, так как эти характеристики не применимы для велосипедов. Тип транспортного средства будет обозначен как Bicycle.
...
ORDER BY
    CASE WHEN horsepower IS NULL THEN 1 ELSE 0 END,
    horsepower DESC;